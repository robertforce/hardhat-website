...
import { MenuItemType, NavigationPagesPaths, SocialsEnum } from './components/ui/types';
...
export const REPO_URL = 'https://github.com/NomicFoundation/hardhat-website/edit/main/src/content/';
