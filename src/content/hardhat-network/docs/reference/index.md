...
If you are using [`hardhat-ethers`](https://github.com/NomicFoundation/hardhat/tree/v2/packages/hardhat-ethers), call `getSigner` after impersonating the account:
