---
title: snapshotGas cheatcodes
description: snapshotGas cheatcodes documentation
---
...
> ⚠️ **Gas snapshots are not yet fully supported.**
...
>
> You can enable isolation mode by setting `isolate` to `true` in [Solidity tests configuration](https://hardhat.org/docs/reference/configuration#solidity-tests-configuration).
