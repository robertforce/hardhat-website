...
- If there is an active broadcast:
  ...
  - `callerMode` will be equal to:
    - `CallerMode.Broadcast` if the broadcast has been set with [`broadcast`](/docs/cheatcodes/broadcast).
    - `CallerMode.RecurrentBroadcast` if the broadcast has been set with [`startBroadcast`](/docs/cheatcodes/start-broadcast).
...
- [broadcast](/docs/cheatcodes/broadcast)
- [startBroadcast](/docs/cheatcodes/start-broadcast)
