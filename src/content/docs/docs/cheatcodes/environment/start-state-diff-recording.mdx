...
Refer to [`stopAndReturnStateDiff`](/docs/cheatcodes/environment/stop-and-return-state-diff) for more details on how to access and interpret the recorded state changes.
