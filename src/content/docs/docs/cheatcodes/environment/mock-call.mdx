...
Mocked calls are in effect until [`clearMockedCalls`](/docs/cheatcodes/clear-mocked-calls) is called.
...
>
> To circumvent this, use the [`etch`](/docs/cheatcodes/etch) cheatcode if the mocked address has no code.
