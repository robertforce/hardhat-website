...
Finally, the user writes the JSON object to a JSON file by using [writeJson](/docs/cheatcodes/external/write-json).
Alternatively, the user can write the JSON object to TOML file by using [writeToml](/docs/cheatcodes/external/write-toml).

**Remember:** The file path needs to be in the allowed paths. Read more in [File cheatcodes](/docs/cheatcodes/file/fs).
...
- [writeJson](/docs/cheatcodes/external/write-json)
