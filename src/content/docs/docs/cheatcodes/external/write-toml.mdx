...
This is usually built through [serializeJson](/docs/cheatcodes/external/serialize-json).
...
**Remember:** The file path `path` needs to be in the allowed paths. Read more in [File cheatcodes](/docs/cheatcodes/file/fs).
...
- [serializeJson](/docs/cheatcodes/external/serialize-json)
