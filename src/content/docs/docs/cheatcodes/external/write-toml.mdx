...
This is usually built through [serializeJson](/docs/cheatcodes/serialize-json).
...
**Remember:** The file path `path` needs to be in the allowed paths. Read more in [File cheatcodes](/docs/cheatcodes/fs).
...
- [serializeJson](/docs/cheatcodes/serialize-json)
