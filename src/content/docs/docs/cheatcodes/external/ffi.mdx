---
title: ffi
description: ffi cheatcode documentation
---
...
Calls an arbitrary command if [`ffi`](https://hardhat.org/docs/reference/configuration#solidity-tests-configuration) is enabled.
