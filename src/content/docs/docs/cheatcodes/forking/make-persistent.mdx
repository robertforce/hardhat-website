...
description: makePersistent cheatcode documentation
---
...
Each fork ([`createFork`](/docs/cheatcodes/forking/create-fork)) has its own independent storage, which is also replaced when another fork is selected ([`selectFork`](/docs/cheatcodes/forking/select-fork)).
...
- [isPersistent](/docs/cheatcodes/forking/is-persistent)
