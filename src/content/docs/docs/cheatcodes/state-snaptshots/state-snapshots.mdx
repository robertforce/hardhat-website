---
title: snapshotState cheatcodes
description: snapshotState cheatcodes documentation
---
...
contract SnapshotStateTest is Test {
  ...
  function testSnapshotState() public {
    ...
    assertEq(
      ...
      5 ether,
      "snapshot revert for balance unsuccessful"
    );
    assertEq(
      block.timestamp,
      timestamp,
      "snapshot revert for timestamp unsuccessful"
    );
  }
}
```
