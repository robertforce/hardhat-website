...
Alternatively, you can create a Hardhat Runtime Environment with an inline `HardhatUserConfig`, the same type used as parameter in `defineConfig` of your config files.
