...
You can learn more about how to customize your Solidity version and settings in [this guide](/docs/guides/writing-contracts/configuring-the-compiler).
...
Learn more at [writing Solidity tests here](/docs/guides/testing/using-solidity).
...
Your deployment was successfully executed in a network simulated by Hardhat! To learn more about how to deploy contracts with Ignition, including how to connect to a real network and how to manage your private keys, please read [this guide](/docs/guides/deployment).
