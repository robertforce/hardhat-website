...
For technical details on what the `op` Chain Type changes and which chains are supported, see the [OP Stack support reference](/docs/reference/op-stack-support).
