...
EDR provides additional JSON-RPC methods that are useful for development and testing. These methods allow you to do things like manipulate the blockchain state or control mining behavior. You can read their reference documentation [in this section](/docs/reference/json-rpc).
