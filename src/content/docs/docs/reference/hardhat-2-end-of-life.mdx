...
walks you through the upgrade in just a few easy steps. If you use an AI coding
agent, you can install our Hardhat 2 to Hardhat 3 migration skill to have it
aid your migration:
