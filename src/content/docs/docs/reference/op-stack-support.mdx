...
{
// NOTE: If Hardhat exposes EDR's `baseFeeConfig` option in the future, update the paragraph above
// to mention that users can override base fee parameters manually.
}
