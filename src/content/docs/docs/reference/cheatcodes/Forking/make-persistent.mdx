...
Each fork ([`createFork`](/docs/reference/cheatcodes/forking/create-fork)) has its own independent storage, which is also replaced when another fork is selected ([`selectFork`](/docs/reference/cheatcodes/forking/select-fork)).
