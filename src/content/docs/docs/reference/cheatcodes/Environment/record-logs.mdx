---
title: recordLogs
description: recordLogs cheatcode documentation
---
...
Tells the VM to start recording all the emitted events. To access them, use [`getRecordedLogs`](/docs/reference/cheatcodes/environment/get-recorded-logs).
