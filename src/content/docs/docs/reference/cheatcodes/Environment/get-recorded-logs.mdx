---
title: getRecordedLogs
description: getRecordedLogs cheatcode documentation
---
...
Gets the emitted events recorded by [`recordLogs`](/docs/reference/cheatcodes/environment/record-logs).
