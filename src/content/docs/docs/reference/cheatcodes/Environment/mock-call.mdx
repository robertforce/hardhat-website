...
Mocked calls are in effect until [`clearMockedCalls`](/docs/cheatcodes/environment/clear-mocked-calls) is called.
...
To circumvent this, use the [`etch`](/docs/cheatcodes/environment/etch) cheatcode if the mocked address has no code.
:::
