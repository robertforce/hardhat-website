...
Hardhat 3 includes built-in support for [code coverage](/docs/guides/testing/code-coverage), [gas statistics](/docs/guides/testing/gas-statistics), and debugging with [execution traces](/docs/guides/execution-traces). These features are available to both Solidity and TypeScript tests.
...
- To learn how to run your Solidity tests with different settings, read the [Test Profiles guide](/docs/guides/testing/test-profiles)
