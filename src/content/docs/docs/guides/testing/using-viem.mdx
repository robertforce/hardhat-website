...
To do this, configure Hardhat to compile the contract and generate its artifacts. Read [this guide](/docs/guides/writing-contracts/configuring-the-compiler#generating-artifacts-from-npm-dependencies) to learn how.
