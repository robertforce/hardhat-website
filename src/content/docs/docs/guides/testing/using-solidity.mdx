...
When writing Solidity tests in Hardhat, you can use [Solidity test cheatcodes](/docs/cheatcodes/cheatcodes-overview) to manipulate the EVM state and control the execution environment of your tests.

For example, you can use the [`vm.prank`](/docs/cheatcodes/environment/prank) cheatcode to change the `msg.sender` for the next call:
