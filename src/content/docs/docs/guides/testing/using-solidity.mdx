...
To read about learn more about how to configure your Solidity tests you can read [their Configuration reference](/docs/reference/configuration#solidity-tests-configuration).
