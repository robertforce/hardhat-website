...
Build Profiles only affect how your contracts are compiled. To run your Solidity tests with different settings, use [Test Profiles](/docs/guides/testing/test-profiles), which are selected separately with `--test-profile`.
