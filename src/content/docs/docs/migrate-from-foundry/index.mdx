...
3.  **Port your test execution settings**
    ...
    If your tests use `forge-config:` annotations, they keep working. Read the [inline configuration](/docs/guides/testing/inline-configuration) guide to see how they interact with Test Profiles.
