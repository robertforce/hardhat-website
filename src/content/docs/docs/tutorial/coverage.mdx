...
Hardhat 3 has built-in test coverage functionality to help you identify untested code. It works with Solidity tests by default, and with the `hardhat-toolbox-viem` plugin you installed, it also works with TypeScript tests.
...
The output shows a coverage summary at the end.
