...
When you run your tests, the `testFuzz_Inc` function will be called multiple times with values that fit in a `uint8` (between 0 and 255). This tests the `inc` function with a wide range of inputs.
