...
By extending the `Test` contract we get access to the functions declared in the assertion library.
...
:::tip
To learn more about Solidity dependencies in Hardhat, check out [our guide](/docs/guides/writing-contracts/dependencies).
:::
