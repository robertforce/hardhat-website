...
If you don't have Node.js installed, or you have an older version, you can follow [this guide](https://www.nvmnode.com/guide/download.html) to install it using the Node Version Manager or `nvm`.
...
You'll be prompted to select a few options. Accept the defaults for everything, **except the project type**:
