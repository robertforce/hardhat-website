...
Before you start, make sure you have [Node.js](https://nodejs.org/) 22.13.0+ and a package manager (such as `npm` or `pnpm`) installed:
...
:::note
You can run the same initialization non-interactively with:

<RunRemote command="hardhat --init --template minimal" />
:::
