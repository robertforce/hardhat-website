...
If you don't have Node.js installed, or you have an older version, you can install the [Node Version Manager](https://www.nvmnode.com/) or `nvm` to install Node.js or upgrade it.
