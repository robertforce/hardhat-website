...
Hardhat has extensions for Visual Studio Code, Cursor, and Antigravity. These extensions add language support for Solidity, integration with Hardhat projects, and experimental support for Foundry, Truffle, and Ape projects.
...
Learn more about it its [Visual Studio Code Marketplace page](https://marketplace.visualstudio.com/items?itemName=NomicFoundation.hardhat-solidity) or [Open VSX Registry page](https://open-vsx.org/extension/NomicFoundation/hardhat-solidity).
...
To use the extension in Cursor, please click [this link](antigravity:extension/NomicFoundation.hardhat-solidity) to install it.
