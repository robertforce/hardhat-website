...
Plugins can extend the HRE. For example, [hardhat-ethers](https://github.com/NomicFoundation/hardhat/tree/v2/packages/hardhat-ethers) adds an Ethers.js instance to it, making it available to tasks, tests and scripts.
