...
export const lightPalette = {
  ...
  getStartedTopBackground: 'linear-gradient(180deg, #ffffff 3.12%, rgba(255, 255, 255, 0) 67.71%)',
  getStartedBottomBackground: 'linear-gradient(180deg, #ffffff 0%, rgba(255, 255, 255, 0) 55.73%)',
  ...
  cookiePopUpBackground: '#FBFBFB',
  cookieTextColor: '#4A4D54',
  cookieShadow: 'rgba(210, 211, 213, 0.50)',
  backButton: '#6E6F70',
...
export const darkPalette = {
  ...
  mottoIgnitionBackground: '#f3ecf3',
  mottoVscodeBackground: '#f0e7fb',
  getStartedTopBackground: 'linear-gradient(180deg, #0A0A0A 3.12%, rgba(255, 255, 255, 0) 67.71%)',
  getStartedBottomBackground: 'linear-gradient(180deg, #0A0A0A 0%, rgba(255, 255, 255, 0) 55.73%)',
  textureBackground: 'linear-gradient(254.24deg, #E9DEFA 0%, #FBFCDB 100%, #FBFCDB 100%);',
  neutralBackground:
    'linear-gradient(180deg, #FFFFFF 7.96%, rgba(255, 255, 255, 0.484844) 18.71%, rgba(255, 255, 255, 0) 28.83%, rgba(255, 255, 255, 0) 68.82%, #FFFFFF 91.43%);',
  link: '#CCB200',
  ...
  cookiePopUpBackground: '#16181D',
  cookieTextColor: '#B0B2B5',
  cookieShadow: 'rgba(74, 77, 84, 0.50)',
  backButton: '#F2F2F2',
  toolsBoxShadow1: '#EEE3FF',
  toolsBoxShadow2: '#FBFCDB',
  toolsBoxShadowDark: '#04040566',
...
export const ThemeProvider = ({ children }: React.PropsWithChildren<{}>): JSX.Element => {
  ...
  useEffect(() => {
    const savedTheme = (localStorage.getItem('theme') as ThemesEnum) || ThemesEnum.AUTO;
    setTheme(savedTheme);
  }, []);
...
export const tm = (cb: ThemeSelect<{ colors: Palette }>) => () => ((fn) => fn(theming.useTheme().light))(cb);

export const tmDark = (cb: ThemeSelect<{ colors: Palette }>) => () => ((fn) => fn(theming.useTheme().dark))(cb);
